  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between border-b bg-background px-4 py-2">
      <div className="flex items-center gap-3">
        ...
        <Link href="/" className="text-lg font-bold md:hidden">Miss Floss</Link>
      </div>
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" asChild>
          ...
          >
            <span className="hidden sm:inline text-xs font-medium">Miss Floss</span>
          </a>
        </Button>
      </div>
    </header>
      ...
      {shouldShowSidebar ? (
        <div className="flex min-h-screen w-full">
          ...
          <SidebarInset className="flex-1">
            ...
            {stickyTabs && (
              <div className="sticky top-0 z-40 bg-[#FFFFFF] border-b border-gray-200">
