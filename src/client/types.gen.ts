...
export type ClientOptions = {
    baseUrl: 'https://app.miss-floss.com' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., miss-floss_staging)
     */
...
export type CurrentUsageResponse = {
    ...
    period_end: string;
    /**
     * Used Miss Floss Tokens
     */
    used_miss-floss_tokens: number;
    /**
     * Quota Miss Floss Tokens
     */
...
export type DailyUsageBreakdownResponse = {
    ...
    /**
     * Total Miss Floss Tokens
     */
    total_miss-floss_tokens: number;
    /**
     * Currency
     */
    currency?: string | null;
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by Miss Floss from fixed values or workflow context templates.
     */
 ...
 * PresetToolParameter
 *
 * A parameter injected by Miss Floss at runtime.
 */
...
export type GetVoicesApiV1UserConfigurationsVoicesProviderGetData = {
    ...
    path: {
         ...
         * Provider
         */
        provider: 'elevenlabs' | 'deepgram' | 'sarvam' | 'cartesia' | 'miss-floss' | 'rime';
    };
    query?: {
        /**
         * Model
