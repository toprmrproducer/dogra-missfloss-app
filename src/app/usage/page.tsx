    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            <div>
                ...
                <Card className="mb-6">
                    <CardHeader>
                        <CardTitle>Miss Floss Model Credits</CardTitle>
                        <CardDescription>
                            These track usage of Miss Floss models using Miss Floss Service Keys.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {isLoadingCredits ? (
                            ...
                            <p className="text-muted-foreground">No Miss Floss service keys configured. Set up a service key in your model configuration to see usage.</p>
                        )}
                    </CardContent>
                </Card>
