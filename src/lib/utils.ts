...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. app.missfloss.ai). The route will set the
  ...
  // superadmin.missfloss.ai we want to switch to app.missfloss.ai. For any other domain
